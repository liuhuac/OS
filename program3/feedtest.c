...
void snoozer() {
   ...
   printf("Starting snoozer%2d, tid %p\n", myid, tid()); fflush(stdout);
   ...
   fprintf(stdout, "snooze%2d ending - priority %d, tid=%p\n", myid,
           tpriority(), tid()); fflush(stdout);
   texit();
}
...
void looper() {
   ...
   printf("Starting looper%2d, tid=%p\n", myid, tid()); fflush(stdout);
   ...
   tsnooze(1);
   fprintf(stdout, "Looper%2d ending - priority %d, tid=%p\n", myid,
           tpriority(), tid()); fflush(stdout);
   texit();
}
...
void schizoid() {
   ...
   printf("Starting schizoid%2d, tid=%p\n", myid, tid()); fflush(stdout);
   ...
   fprintf(stdout, "schizoid%2d ending - priority %d, tid=%p\n", myid,
           tpriority(), tid()); fflush(stdout);
   texit();
}
